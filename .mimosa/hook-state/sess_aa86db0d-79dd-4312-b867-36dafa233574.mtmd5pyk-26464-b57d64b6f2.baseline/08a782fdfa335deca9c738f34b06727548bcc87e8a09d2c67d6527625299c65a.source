...
func (a *MemFSAdapter) Mkdir(ctx context.Context, name string, perm os.FileMode) error {
	// TODO: extract owner from context
	return a.fs.Mkdir(ctx, name, 1)
}
